...
public class TripDestinationStep extends Step<String> {

    private AppCompatTextView locationText , locationValue;
    private AutocompleteSupportFragment mDestination;
    private FragmentManager fragmentManager;
    private static final String TAG = TripDestinationStep.class.getSimpleName();

    public TripDestinationStep(String title , FragmentManager fragmentManager) {
        super(title);
    ...
    protected IsDataValid isStepDataValid(String stepData) {
        ...
        String errorMessage = !isTypeValid ? getContext().getResources().getString(R.string.error_destination) : "";
    ...
    protected View createStepContentLayout() {
        ...
        View view = inflater.inflate(R.layout.trip_destination_layout, null);

        locationText = view.findViewById(R.id.destination_text);
        locationValue = view.findViewById(R.id.destination_value);
        mDestination = (AutocompleteSupportFragment)fragmentManager.findFragmentById(R.id.destination_select);

        locationText.setText(getContext().getResources().getString(R.string.destination));
        ...
        locationValue.setText("Cairo".concat(" , ").concat("30.0444").concat(" , ").concat("31.2357"));

        mDestination.setPlaceFields(Arrays.asList(Place.Field.ID, Place.Field.NAME,Place.Field.LAT_LNG));
